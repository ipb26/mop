...
export const is = <I>(is: I, error: ErrorFactory<I> = "Must be equal to " + is) => flow(predicate(_ => _ === is, error))
export const isNot = <I>(is: I, error: ErrorFactory<I> = "Must not be equal to " + is) => flow(predicate(_ => _ !== is, error))
